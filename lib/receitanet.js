...
/**
 * ✅ Notifica pagamento (usado para "liberação provisória" após validar comprovante)
 * Docs: POST /notificacao-pagamento
 * Retorno costuma ter: { success, idCliente, liberado, msg, contato, protocolo, status, liberado_ate }
 */
