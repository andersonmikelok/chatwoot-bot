...
/**
 * Analisa imagem (comprovante) e retorna objeto padronizado:
 * {
...
- "barcode_or_line": se aparecer linha digitável/código de barras/identificador do boleto, copie exatamente (pode vir com espaços).
- summaryText deve ser curto (estilo WhatsApp), ex: "Identifiquei pagamento por PIX no valor X em DD/MM."
`.trim();
